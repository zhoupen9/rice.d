...
hl.bind(mainMod .. " + equal",          hl.dsp.window.resize({ x = 240, y = 0, relative = true }))
hl.bind(mainMod .. " + minus",          hl.dsp.window.resize({ x = -240, y = 0, relative = true }))
hl.bind(mainMod .. " + bracketright",   hl.dsp.window.resize({ x = 120, y = 0, relative = true}))
hl.bind(mainMod .. " + bracketleft",    hl.dsp.window.resize({ x = -120, y = 0, relative = true}))
...
hl.bind(mainMod .. " + prior",          hl.dsp.focus({ direction = "left" }))
hl.bind(mainMod .. " + next",           hl.dsp.focus({ direction = "right" }))
